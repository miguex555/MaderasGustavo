...
import services.UsuariosFacade;
...
public class UsuariosController implements Serializable {
    ...
    @EJB
    private services.UsuariosFacade ejbFacade;
    ...
    {
        boolean retorno = ejbFacade.ValidarUsuario(current); 
        ...
        {
            JsfUtil.addSuccessMessage("Usuario invalido");
            return "";
        }
